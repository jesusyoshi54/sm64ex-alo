...
const Trajectory KoopaTHI_path[] = {
	TRAJECTORY_POS(0,19036,11173,-5539),
	TRAJECTORY_POS(1,19192,11173,-3143),
	TRAJECTORY_POS(2,18046,11173,-2049),
	TRAJECTORY_POS(3,17526,11173,-1060),
	TRAJECTORY_POS(4,17213,11173,815),
	TRAJECTORY_POS(5,17317,11173,2274),
	TRAJECTORY_POS(6,17994,11173,4149),
	TRAJECTORY_POS(7,19036,11173,5086),
	TRAJECTORY_POS(8,19557,9402,5451),
	TRAJECTORY_POS(9,20107,9294,7039),
	TRAJECTORY_END(),
};
