...
TERRAIN(col_castle_inside_1_0xe044750),
...
OBJECT_WITH_ACTS(0,-25,-974,-1308,0,0,0,0x60000, bhvWarp,31),
OBJECT_WITH_ACTS(0,-888,-1225,-5380,0,108,0,0x0, bhvWarp,31),
OBJECT_WITH_ACTS(0,1031,-1185,-5325,0,67,0,0x40000, bhvWarp,31),
OBJECT_WITH_ACTS(0,-1610,1130,5893,0,160,0,0x10000, bhvWarp,31),
OBJECT_WITH_ACTS(0,1466,1152,5842,0,283,0,0x30000, bhvWarp,31),
OBJECT_WITH_ACTS(0,15,-974,1312,0,0,0,0x20000, bhvWarp,31),
OBJECT_WITH_ACTS(0,1000,300,-195,0,0,0,0x50000, bhvFadingWarp,31),
OBJECT_WITH_ACTS(124,1000,18,-195,0,-90,0,0x80000, bhvMessagePanel,31),
OBJECT_WITH_ACTS(0,-39,1320,4501,0,0,0,0xa0000, bhvPaintingStarCollectWarp,31),
OBJECT_WITH_ACTS(0,-11,-374,-3339,0,0,0,0xb0000, bhvPaintingStarCollectWarp,31),
OBJECT_WITH_ACTS(0,24,360,104,0,0,0,0x70000, bhvFadingWarp,31),
OBJECT_WITH_ACTS(0,-11,-381,-3328,0,0,0,0xd0000, bhvPaintingDeathWarp,31),
OBJECT_WITH_ACTS(0,0,365,0,0,0,0,0xf10000, bhvPaintingDeathWarp,31),
OBJECT_WITH_ACTS(0,-40,1354,4501,0,0,0,0xc0000, bhvPaintingDeathWarp,31),
RETURN()
};
const LevelScript local_warps_castle_inside_1_[] = {
WARP_NODE(10,6,1,10,0),
WARP_NODE(11,6,1,11,0),
WARP_NODE(12,6,1,12,0),
WARP_NODE(13,6,1,13,0),
WARP_NODE(14,6,1,14,0),
WARP_NODE(7,6,1,21,0),
