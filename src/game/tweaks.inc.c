...
#define HUD_COINS_Y 179
#define HUD_COINS_CROSS_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(38)
#define HUD_COINS_CROSS_Y 179
#define HUD_COINS_NUM_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(59)
#define HUD_COINS_NUM_Y 179
