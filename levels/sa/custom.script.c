...
AREA(1,Geo_sa_1_0x1523430),
TERRAIN(col_sa_1_0xe00e150),
...
OBJECT_WITH_ACTS(0,4,12030,0,0,180,0,0xa0000, bhvSwimmingWarp,31),
OBJECT_WITH_ACTS(0,0,-1800,0,0,0,0,0x2f0b0000, bhvWarp,31),
OBJECT_WITH_ACTS(217,0,-2147,0,0,0,0,0x0, bhvPushableMetalBox,31),
RETURN()
};
const LevelScript local_warps_sa_1_[] = {
WARP_NODE(10,9,1,0,0),
WARP_NODE(11,25,1,10,0),
