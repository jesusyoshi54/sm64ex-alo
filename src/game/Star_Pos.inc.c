#define KoopaBoBStarPos { -15440, -3000, 15400 }
...
#define WigglerStarPos -2000.0f, 1300.0f, 6000.0f
#define PssSlideStarPos 25000.0f, -3666.0f, 650.0f
...
#define BalconyBooStarPos 7675.0f, 6600.0f, 200.0f
