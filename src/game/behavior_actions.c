...
s32 D_8032F0C0[] = { SAVE_FLAG_HAVE_WING_CAP, SAVE_FLAG_HAVE_METAL_CAP, SAVE_FLAG_HAVE_VANISH_CAP, SAVE_FLAG_MOAT_DRAINED};
...
#include "behaviors/Scroll_F2.inc.c"
#include "behaviors/SR625_Door.inc.c"
