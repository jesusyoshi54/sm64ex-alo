...
OBJECT_WITH_ACTS(0,16,5,30,0,0,0,93, editor_Scroll_Texture,31),
OBJECT_WITH_ACTS(0,16,5,24,0,0,0,94, editor_Scroll_Texture,31),
OBJECT_WITH_ACTS(0,64,4,24,0,0,0,95, editor_Scroll_Texture,31),
RETURN()
};
