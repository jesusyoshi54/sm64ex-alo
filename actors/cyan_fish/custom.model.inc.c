...
Light_t Light_cyan_fish_geo_0x600dc70 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

Ambient_t Light_cyan_fish_geo_0x600dc68 = {
{127, 127, 127}, 0, {127, 127, 127}, 0
};

Gfx DL_cyan_fish_geo_0x600ddd8[] = {
gsDPPipeSync(),
...
Gfx DL_cyan_fish_geo_0x600dd20[] = {
...
Light_t Light_cyan_fish_geo_0x600df50 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

Ambient_t Light_cyan_fish_geo_0x600df48 = {
{127, 127, 127}, 0, {127, 127, 127}, 0
};

Gfx DL_cyan_fish_geo_0x600e038[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE, TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
gsSPTexture(65535, 65535, 0, 0, 1),
...
Gfx DL_cyan_fish_geo_0x600dfc0[] = {
gsDPSetTextureImage(0, 2, 1, cyan_fish_geo__texture_0600D468),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
Light_t Light_cyan_fish_geo_0x600de40 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

Ambient_t Light_cyan_fish_geo_0x600de38 = {
{127, 127, 127}, 0, {127, 127, 127}, 0
};

Gfx DL_cyan_fish_geo_0x600ded8[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE, TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE),
...
Gfx DL_cyan_fish_geo_0x600de90[] = {
gsDPSetTextureImage(0, 2, 1, cyan_fish_geo__texture_0600D468),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
