...
const GeoLayout ccm_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(4, ccm_dl_DL_jrb_1_0xe052270_Obj_mesh_layer_4),
		GEO_DISPLAY_LIST(4, ccm_dl_DL_jrb_1_0xe06a3a8_Obj_mesh_layer_4),
		GEO_DISPLAY_LIST(5, ccm_dl_DL_jrb_1_0xe06b198_Obj_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
