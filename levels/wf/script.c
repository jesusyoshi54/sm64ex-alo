...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		WARP_NODE(240, LEVEL_CASTLE_GROUNDS, 0x01, 0x2B, WARP_NO_CHECKPOINT),
		WARP_NODE(241, LEVEL_CASTLE_GROUNDS, 0x01, 0x2C, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_WF, 0x02, 0x0A, WARP_CHECKPOINT),
		...
		OBJECT(MODEL_BLUE_COIN_SWITCH, -7, 6954, 1, 0, 0, 0, 0x00000150, bhvBlueCoinSwitch),
		OBJECT(MODEL_BLUE_COIN, 1546, 7769, -955, 0, 0, 0, 0, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -1664, 7769, -955, 0, 0, 0, 0, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -1664, 7713, 962, 0, 0, 0, 0, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 1527, 7713, 962, 0, 0, 0, 0, bhvHiddenBlueCoin),
		...
		OBJECT(MODEL_CHUCKYA, 7610, 394, 7089, 0, -46, 0, 0, bhvChuckya),
		...
		OBJECT(0, 13910, 7001, 3748, 0, -180, 0, 0x00110000, bhvCoinFormation),
		OBJECT(0, 13910, 7631, 3748, 0, -180, 0, 0x00110000, bhvCoinFormation),
		...
		OBJECT(0, 7612, 258, 7112, 0, 25, 0, 0x00020000, bhvCoinFormation),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 410, 249, 8, 0, -90, 0, 0x00420000, bhvMessagePanel),
	...
	AREA(3, wf_area_3),
		...
		WARP_NODE(240, LEVEL_CASTLE_GROUNDS, 0x1, 0x2B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0C, LEVEL_WF, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(241, LEVEL_CASTLE_GROUNDS, 0x01, 0x2C, WARP_NO_CHECKPOINT),
