...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_THI_WARP_PIPE, 2490, -194, 795, 0, 0, 0, 0x00010000, bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 3327, -194, -1079, 0, 0, 0, 0x00020000, bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 1677, -194, -2286, 0, 0, 0, 0x00030000, bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 0, 1736, 0, 0, 0, 0, 0x00040000, bhvWarpPipe),
