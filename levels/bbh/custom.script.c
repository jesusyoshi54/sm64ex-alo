...
OBJECT_WITH_ACTS(0,2,4,96,0,0,0,0,editor_Scroll_Texture,31),
OBJECT_WITH_ACTS(0,4,5,96,0,0,0,1,editor_Scroll_Texture,31),
OBJECT_WITH_ACTS(0,16,5,42,0,0,0,2,editor_Scroll_Texture,31),
RETURN()
};
