...
#define	RM_RA_ZB_XLU_SURF(clk)					\
	AA_EN | Z_CMP | CVG_DST_WRAP | CLR_ON_CVG |	\
	FORCE_BL | ZMODE_XLU |					\
	GBL_c##clk(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA)
...
#define	RM_RA_XLU_SURF(clk)					\
	AA_EN | CVG_DST_WRAP | CLR_ON_CVG | FORCE_BL |	\
	ZMODE_OPA |						\
	GBL_c##clk(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA)
...
#define	G_RM_RA_ZB_XLU_SURF	RM_RA_ZB_XLU_SURF(1)
#define	G_RM_RA_ZB_XLU_SURF2	RM_RA_ZB_XLU_SURF(2)
