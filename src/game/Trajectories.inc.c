...
const Trajectory rr_seg7_trajectory_0702EC3C_RM2C_path[] = {
	TRAJECTORY_POS(0,-8492,193,-7506),
	TRAJECTORY_POS(1,-8492,193,-11521),
	TRAJECTORY_POS(2,-11843,193,-11521),
	TRAJECTORY_POS(3,-12354,470,-11521),
	TRAJECTORY_POS(4,-12354,-369,-11521),
	TRAJECTORY_POS(5,-13360,-369,-11521),
	TRAJECTORY_END(),
};
