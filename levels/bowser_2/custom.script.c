...
OBJECT_WITH_ACTS(0,16,5,30,3,0,0,95, editor_Scroll_Texture,31),
OBJECT_WITH_ACTS(0,16,5,24,6,0,0,96, editor_Scroll_Texture,31),
OBJECT_WITH_ACTS(0,64,4,24,9,0,0,97, editor_Scroll_Texture,31),
RETURN()
};
