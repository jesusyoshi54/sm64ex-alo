...
void bhv_hidden_blue_coin_loop(void) {
    ...
    switch (o->oAction) {
        ...
        case HIDDEN_BLUE_COIN_ACT_ACTIVE:
            ...
            // delete the object.
            if (cur_obj_wait_then_blink((200+o->oHiddenBlueCoinSwitch->oBehParams), 20)) {
                obj_mark_for_deletion(o);
            }
...
void bhv_blue_coin_switch_loop(void) {
    ...
    switch (o->oAction) {
        ...
        case BLUE_COIN_SWITCH_ACT_TICKING:
            ...
            if (cur_obj_nearest_object_with_behavior(bhvHiddenBlueCoin) == NULL || o->oTimer > (240+o->oBehParams)) {
                obj_mark_for_deletion(o);
            }
