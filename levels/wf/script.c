...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_KING_BOBOMB, -10960, 5565, 8729, 0, 0, 0, 0, bhvKingBobomb),
		OBJECT(MODEL_STAR, 10643, 6856, 3264, 0, 0, 0, 0x01000000, bhvStar),
		OBJECT(MODEL_STAR, -8609, 1215, -7314, 0, 0, 0, 0x04000000, bhvStar),
		OBJECT(MODEL_STAR, 8542, 281, 11281, 0, 0, 0, 0x05000000, bhvStar),
		OBJECT(MODEL_NONE, 7, 487, -9, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -12281, 1623, 8773, 0, 0, 0, 0x000B0000, bhvInstantActiveWarp),
