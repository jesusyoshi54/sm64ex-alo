...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, -1015, -194, 333, 0, 107, 0, 0x003F0000, bhvMessagePanel),
		OBJECT(MODEL_BOBOMB_BUDDY, -7, -673, 410, 0, 0, 0, 0x002B0000, bhvBobombBuddy),
		OBJECT(MODEL_BOBOMB_BUDDY, -249, -673, -367, 0, 0, 0, 0x002D0000, bhvBobombBuddy),
		OBJECT(MODEL_BOBOMB_BUDDY, 287, -673, -340, 0, 0, 0, 0x002C0000, bhvBobombBuddy),
		...
		OBJECT(MODEL_NONE, 1485, 1, -2036, 0, 0, 0, 0x003C0000, bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, 1485, 1, -2036, 0, 0, 0, 0x003B0000, bhvAirborneStarCollectWarp),
		OBJECT(MODEL_NONE, 0, 185, -6, 0, 78, 0, 0x004C0000, bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -15, 1938, 310, 0, 0, 0, 0x005C0000, bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -15, 1938, 310, 0, 0, 0, 0x005B0000, bhvAirborneStarCollectWarp),
		...
		OBJECT(MODEL_NONE, -3979, -120, 1004, 0, 108, 0, 0x001F0000, bhvSignOnWall),
		...
		OBJECT(MODEL_NONE, 1, 1737, -1, 0, 0, 0, 0x00040000, bhvFadingWarpUnlock),
		OBJECT(MODEL_NONE, -3491, 2656, 1084, 0, 0, 0, 0x00050000, bhvFadingWarp),
		OBJECT(249, -3491, 2637, 1084, 0, 0, 0, 0x00050000, bhvWarpRing),
		OBJECT(249, 1, 1729, -1, 0, 24, 0, 0x00050000, bhvWarpRingUnlock),
