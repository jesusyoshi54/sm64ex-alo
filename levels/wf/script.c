...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(0, 13821, 5721, -7262, 0, -180, 0, 0x00110000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, 6, 488, 1, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		...
		OBJECT(MODEL_NONE, -12778, 1344, 8190, 0, 0, 0, 0x000B0000, bhvWarp),
		OBJECT(MODEL_NONE, 13829, 4763, -7284, 0, 0, 0, 0x300C0000, bhvWarp),
