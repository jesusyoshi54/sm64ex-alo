...
#define TuxieMotherStarPos -6732.0f, 598.0f, -19364.0f
#define WigglerStarPos 0.0f, 692.0f, 0.0f
#define PssSlideStarPos 13912.0f, -7863.0f, -1520.0f
...
#define BalconyBooStarPos 18881.0f, 3595.0f, -8361.0f
