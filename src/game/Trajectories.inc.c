...
const Trajectory rr_seg7_trajectory_0702EC3C_RM2C_path[] = {
	TRAJECTORY_POS(0,-4163,-1719,-5282),
	TRAJECTORY_POS(1,-3415,-1556,-5282),
	TRAJECTORY_POS(2,-1853,-1556,-4345),
	TRAJECTORY_POS(3,-464,-1556,-1157),
	TRAJECTORY_POS(4,-464,-946,3163),
	TRAJECTORY_POS(5,-1377,-946,3503),
	TRAJECTORY_POS(6,-3147,-946,3503),
	TRAJECTORY_POS(7,-4262,-311,2215),
	TRAJECTORY_POS(8,-4262,1484,-1200),
	TRAJECTORY_POS(9,-4262,1484,-1747),
	TRAJECTORY_POS(10,-4262,1484,-2300),
	TRAJECTORY_POS(11,-4262,1956,-2607),
	TRAJECTORY_POS(12,-3195,2590,-4080),
	TRAJECTORY_POS(13,-1900,2590,-4080),
	TRAJECTORY_POS(14,-460,3559,-4080),
	TRAJECTORY_POS(15,1163,3559,-4080),
	TRAJECTORY_POS(16,2068,3559,-4845),
	TRAJECTORY_POS(17,2068,3559,-5645),
	TRAJECTORY_POS(18,1311,3559,-6170),
	TRAJECTORY_POS(19,-1250,5504,-6170),
	TRAJECTORY_END(),
};
const Trajectory rr_seg7_trajectory_0702ECC0_RM2C_path[] = {
	TRAJECTORY_POS(0,-3115,-4259,-5317),
	TRAJECTORY_POS(1,-3987,-4207,-5353),
	TRAJECTORY_POS(2,-5478,-3686,-4876),
	TRAJECTORY_POS(3,-5741,-3217,-3378),
	TRAJECTORY_POS(4,-5183,-2740,-2819),
	TRAJECTORY_POS(5,-4608,-2436,-2673),
	TRAJECTORY_POS(6,-3739,-2228,-2905),
	TRAJECTORY_POS(7,-2778,-2957,-3933),
	TRAJECTORY_END(),
};
