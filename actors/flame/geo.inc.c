...
const GeoLayout yellow_flame_geo[] = {
   ...
   GEO_OPEN_NODE(),
      GEO_SWITCH_CASE(8, geo_switch_anim_state),
      GEO_OPEN_NODE(),
         GEO_DISPLAY_LIST(LAYER_TRANSPARENT, Yflame_seg3_dl_0301B500),
         GEO_DISPLAY_LIST(LAYER_TRANSPARENT, Yflame_seg3_dl_0301B518),
         GEO_DISPLAY_LIST(LAYER_TRANSPARENT, Yflame_seg3_dl_0301B530),
         GEO_DISPLAY_LIST(LAYER_TRANSPARENT, Yflame_seg3_dl_0301B548),
         GEO_DISPLAY_LIST(LAYER_TRANSPARENT, Yflame_seg3_dl_0301B560),
         GEO_DISPLAY_LIST(LAYER_TRANSPARENT, Yflame_seg3_dl_0301B578),
         GEO_DISPLAY_LIST(LAYER_TRANSPARENT, Yflame_seg3_dl_0301B590),
         GEO_DISPLAY_LIST(LAYER_TRANSPARENT, Yflame_seg3_dl_0301B5A8),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_END(),
};
