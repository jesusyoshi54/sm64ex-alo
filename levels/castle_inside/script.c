...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		WARP_NODE(2, LEVEL_CCM, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(3, LEVEL_BBH, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(4, LEVEL_HMC, 1, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(5, LEVEL_LLL, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_RED_FLAME, 2, 123, -1300, 0, 45, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_RED_FLAME, 1306, 123, 2, 0, 45, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_RED_FLAME, 2, 123, 1284, 0, 45, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_RED_FLAME, -1294, 123, -1, 0, 45, 0, 0x00000000, bhvFlame),
