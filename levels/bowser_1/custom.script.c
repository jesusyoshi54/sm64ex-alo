...
TERRAIN(col_bowser_1_1_0xe004410),
...
OBJECT_WITH_ACTS(0,0,3211,0,0,0,0,0xa0000, bhvSpinAirborneWarp,31),
...
OBJECT_WITH_ACTS(0,525,4378,-9268,0,0,0,0x0, bhvWhompKingBoss,31),
OBJECT_WITH_ACTS(122,514,2532,-7997,0,0,0,0x0, bhvStar,31),
OBJECT_WITH_ACTS(0,-3295,-632,-2732,0,0,0,0x0, bhvWaterfallSoundLoop,31),
OBJECT_WITH_ACTS(0,1590,-632,-4239,0,0,0,0x0, bhvWaterfallSoundLoop,31),
// OBJECT_WITH_ACTS(0,341,5,0,0,0,0,&VB_bowser_1_1_0x0[0], editor_Scroll_Texture,31),
RETURN()
};
