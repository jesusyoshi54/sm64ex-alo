...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_BLUE_COIN, 1546, 7508, -733, 0, 0, 0, 0, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -1664, 7508, -733, 0, 0, 0, 0, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -1664, 7451, 726, 0, 0, 0, 0, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 1527, 7451, 726, 0, 0, 0, 0, bhvHiddenBlueCoin),
