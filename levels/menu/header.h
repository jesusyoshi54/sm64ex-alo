...
#ifdef WIDESCREEN
extern Gfx dl_menu_erase_button_dynamic[];
extern Gfx dl_menu_copy_button_dynamic[];
extern Gfx dl_menu_file_button_dynamic[];
extern Gfx dl_menu_score_button_dynamic[];
extern Gfx dl_menu_sound_button_dynamic[];
extern Gfx dl_menu_generic_button_dynamic[];
#endif
