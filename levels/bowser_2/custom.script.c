...
TERRAIN(col_bowser_2_1_0xe055518),
...
OBJECT_WITH_ACTS(122,533,2604,-7903,0,0,0,0x0, bhvStar,31),
OBJECT_WITH_ACTS(0,507,4378,-9351,0,0,0,0x0, bhvKingBobomb,31),
OBJECT_WITH_ACTS(0,341,4,0,0,0,0,&VB_bowser_2_1_0xe0265d0[8], editor_Scroll_Texture,31),
RETURN()
};
