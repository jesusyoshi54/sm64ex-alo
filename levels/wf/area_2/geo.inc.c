...
const GeoLayout wf_area_2_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(5, 17, -272, 9, wf_dl_Plane_004_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(5, 17, 1225, -4059, wf_dl_Plane_006_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(5, 17, 1225, -4059, wf_dl_Plane_008_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(5, 2, 2235, -7098, wf_dl_Plane_009_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(5, 2, 2235, -7098, wf_dl_Plane_011_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(5, 17, 2806, -7513, wf_dl_Plane_012_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(5, 17, 2806, -7513, wf_dl_Plane_014_mesh_layer_5),
